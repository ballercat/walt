  ...
  <StaticQuery
    ...
    render={data => (
      <Fragment>
        <Helmet
          title={title}
          titleTemplate={`%s - ${data.site.siteMetadata.title} - ${data.site.siteMetadata.subtitle}`}
          defaultTitle={`${data.site.siteMetadata.title} - ${data.site.siteMetadata.subtitle}`}
        ...
        <header>
          {!landing && (
            <h1>
              <img width={85} src={waltImage} alt='' />
              <Link to='/' >Docs</Link>
            </h1>
          )}
          {landing && (
          ...
          <nav>
            <Link to='/demo' title='Live DEMO of Walt'>demo</Link>
            <Link to='/docs' title="Dive in WALT's documentation">docs</Link>
            <a href={data.site.siteMetadata.github} title='WALT on GitHub'>github</a>
          </nav>
        </header>
      </Fragment>
    )}
