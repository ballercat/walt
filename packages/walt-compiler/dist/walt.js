...
function encodeArray(array) {
  ...
  array.forEach(v => {
    stream.push(index_1, v, String(v));
  });
...
function semantics(ast, extraSemantics = [], options) {
  ...
  const { functions, scopes, types, userTypes, statics: statics$$1, hoist } = context;
